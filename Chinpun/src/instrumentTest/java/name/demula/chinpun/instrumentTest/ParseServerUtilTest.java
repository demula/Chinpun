package name.demula.chinpun.instrumentTest;
...
import static name.demula.chinpun.utils.ParseServerUtil.getMonthHoursfromHTML;
import static name.demula.chinpun.utils.ParseServerUtil.getSessionFromJSON;
import static name.demula.chinpun.utils.ParseServerUtil.getUserFirstNamefromHTML;
import static name.demula.chinpun.utils.ParseServerUtil.getUserFromJSON;
import static name.demula.chinpun.utils.ParseServerUtil.getUserIDfromHTML;
import static name.demula.chinpun.utils.ParseServerUtil.getUserLastNamefromHTML;
import static name.demula.chinpun.utils.ParseServerUtil.getWeekHoursfromHTML;

/**
 * Created by Jesus on 29/07/13.
 */
public class ParseServerUtilTest extends InstrumentationTestCase {
  ...
  public void testGetMonthHoursfromHTML_2() throws Exception {
    BufferedReader br = new BufferedReader(
        new InputStreamReader(
            //getInstrumentation().getContext().getAssets().open("raw/welcome.html"),
            getInstrumentation().getContext().getResources().openRawResource(R.raw.welcome_fail),
            "UTF-8"));
    String html;
    try {
      StringBuilder sb = new StringBuilder();
    ...
    //assertNotNull(dom);
    //assertEquals(new String("Te has pasado 35 horas 15 minutos"), getMonthHoursfromHTML(dom));
    assertEquals(28 * 60 + 6, getMonthHoursfromHTML(html));
  }
